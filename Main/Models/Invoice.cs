...
public class Invoice {
    ...
    public double Subtotal { get { return Math.Round(CurrentOrder.Sum(o => o.Subtotal), 2); } }
    public double TotalDiscount { get { return Math.Round(VegetableOffers.Sum(x => x.Discount), 2); } }
    public double FinalAmount { get { return Math.Round(Subtotal - TotalDiscount, 2); } }
